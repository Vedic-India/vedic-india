    ...
    <section className="bg-[#F7FAFC] py-8">
      <div className="mx-auto max-w-7xl min-w-0 px-4 sm:px-6">
        <motion.div
          ...
          className="relative min-w-0 overflow-hidden rounded-[28px] border border-[#EDF2F7] bg-white shadow-[0_14px_40px_rgba(15,23,42,0.05)]"
        >
          <div className="relative grid min-w-0 items-center gap-0 px-5 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:px-14">

            {/* LEFT */}
            <div className="min-w-0 max-w-[430px] pl-0 pt-6 sm:pl-2 lg:pt-4">
              <h2 className="text-[36px] font-bold leading-none text-[#0F172A] sm:text-[42px] lg:text-[46px]">
                Our Story
              </h2>
            ...
            {/* RIGHT */}
            <div className="flex min-w-0 w-full items-end justify-center self-end py-6 lg:justify-end">
              <Image
                ...
                height={650}
                priority
                className="pointer-events-none h-auto w-full max-w-[650px] select-none object-contain"
              />
            </div>
          </div>

          {/* CARDS */}
          <div className="border-t border-[#EDF2F7] px-5 pt-4 pb-6 sm:px-8 lg:px-14">
