...
function PaymentProcessingPageContent() {
  ...
  return (
    <section className="bg-slate-50 pt-24 pb-8">
      <Container>
                ...
                <div className="max-w-2xl space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
                      We couldn&apos;t confirm your payment immediately. Your
                      payment may still be processing. Please check your orders
                      shortly.
                    </p>
                  </div>
                </div>

                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4 shadow-sm sm:min-w-72">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="rounded-3xl border border-slate-200 bg-white p-5">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-500">
                    The backend is still confirming whether the payment was
                ...
                <div className="rounded-3xl border border-slate-200 bg-white p-5">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-500">
                    Your orders page will reflect the final status once
